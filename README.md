...
A multi-branch backend application showcasing CRUD operations, database relationships, EF Core migrations, and authentication with ASP.NET Identity. Highlights enterprise-style architecture and data
modeling.
